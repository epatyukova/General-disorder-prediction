...
class Roost(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, hidden_layer_dims, 
                 ...
                 batchnorm=False, negative_slope=0.2):
        """
        Inputs
        ----------
...
class GNNforNodeClassification(nn.Module):
    """
    The Descriptor Network is the message passing section of the
    Roost Model.
    """
...
# Based on Roost for the start. Later other GNN layers may be added
class Roost_Node_classification(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_layer_dims, 
                 n_graphs, elem_heads, internal_elem_dim, g_elem_dim, f_elem_dim, 
                 batchnorm=False, negative_slope=0.2):
        super().__init__()

        self.material_nn = GNNforNodeClassification(input_dim, n_graphs, elem_heads, internal_elem_dim, g_elem_dim, f_elem_dim, 
                                                    negative_slope=0.2,bias=False)
    ...
    def forward(self, x, edge_index, pos,edge_weight=None):
        ...
        x = self.material_nn(x, edge_index, pos,edge_weight=None)
